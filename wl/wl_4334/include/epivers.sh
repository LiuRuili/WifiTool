...
#
# $Id: epivers.sh 265630 2011-06-10 01:48:13Z $
# 
...
if [ -f epivers.h ]; then
	...
	SVNURL='$HeadURL: http://svn.sj.broadcom.com/svn/wlansvn/proj/tags/PHOENIX2/PHOENIX2_REL_6_10_58_51/src/include/epivers.sh $'
