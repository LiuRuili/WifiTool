 ...
 *
 * $Id: sbchipc.h 324349 2012-03-28 23:03:13Z $
 *
...
/* core capabilities extension */
#define CC_CORE_CAPEXT_LQ_SUPPORTED_SHIFT	0
#define CC_CORE_CAPEXT_LQ_SUPPORTED_MASK	(1 << 0)
#define CC_CORE_CAPEXT_SR_SUPPORTED_SHIFT	1
#define CC_CORE_CAPEXT_SR_SUPPORTED_MASK	(1 << 1)
#define CC_CORE_CAPEXT_SLOWTMR_PRESENT_SHIFT	2
#define CC_CORE_CAPEXT_SLOWTMR_PRESENT_MASK	(1 << 2)
#define CC_CORE_CAPEXT_SR_GRPS_SHIFT		3
#define CC_CORE_CAPEXT_SR_GRPS_MASK		((1 << 4) | (1 << 3))
...
#define PMU_RCTLGRP_CHAIN_LEN_GRP0	338
#define PMU_RCTLGRP_CHAIN_LEN_GRP1	315
...
/* for BCM4324a0 */
#define	PMU4324_CC1_GPIO_CONF_MASK	0x3
#define	PMU4324_CC1_ENABLE_UART_SHIFT	28
#define	PMU4324_CC2_SDIO_AOS_EN_SHIFT	2
#define	PMU4324_CC1_GPIO_CONF(val)	(val & PMU4324_CC1_GPIO_CONF_MASK)
#define	PMU4324_CC1_ENABLE_UART		(1 << PMU4324_CC1_ENABLE_UART_SHIFT)
#define	PMU4324_CC2_SDIO_AOS_EN		(1 << PMU4324_CC2_SDIO_AOS_EN_SHIFT)
