...
public class AbgnMimoFragment extends Fragment {
    private String TAG = "WifiAbgnMimo";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.abgnmimo_view, container, false);
	}
    ...
    public void onStart() {
        ...
        adapter = new ArrayAdapter<String>(
                ...
                new String[]{"802.11b", "802.11g", "802.11n", "802.11a"});
        ...
        adapter = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_spinner_item,
                new String[]{"MCS0", "MCS1", "MCS2", "MCS3", "MCS4", "MCS5", "MCS6", "MCS7", "MCS8", "MCS9", "MCS10", "MCS11", "MCS12", "MCS13", "MCS14", "MCS15"});
	...
	void updateSettings(int TxRx, String mode) {
        if (TxRx == 0 && mode.equals("g")) {
            ...
            mModeSpin.setVisibility(View.VISIBLE);
            mChannelText.setVisibility(View.VISIBLE);
            mChannelNSpin.setVisibility(View.VISIBLE);
            mChannelNSpin.setSelection(0);
            mChannel = "1";
            mRateText.setVisibility(View.VISIBLE);
