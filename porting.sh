...
if [ $TARGET_PROJECT == "ME581C" -o $TARGET_PROJECT == "ME581CL" ];
then
    echo "cp wl_4339"
    cp $OUT_DIR/bin/wl $TARGET_DIR/wl/wl_4339
elif [ $TARGET_PROJECT == "ME375CL" -o $TARGET_PROJECT == "ME176C-L" -o $TARGET_PROJECT == "FE375CL" -o $TARGET_PROJECT == "RD001" ];
then
    echo "cp wl_43430"
